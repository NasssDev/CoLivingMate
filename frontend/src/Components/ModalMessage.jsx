export const ModalMessage = ({message, buttonName, setPopupConfirm, handleAction}) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 px-3">
            ...
            <div className="bg-white shadow-lg relative rounded-xl border border-yellow-500">
                <div className="flex p-2 items-center justify-center w-full bg-yellow-400 rounded-t-xl">
